...
public class DB {
    ...
    public static Connection ConnectToDB() {
        ...
        try {
            ...
            ConnectionURL = "jdbc:jtds:sqlserver://" + ConnectionString.ip + ":" + ConnectionString.port + ";databaseName=" + ConnectionString.dbName;
            connection = DriverManager.getConnection(ConnectionURL, ConnectionString.user, ConnectionString.password);
        } catch (Exception ex) {
